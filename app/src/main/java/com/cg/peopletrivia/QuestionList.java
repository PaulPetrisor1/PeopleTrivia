...
public class QuestionList {
    ...
    public int getQuestion(int a) {
        ...
        int question = nQuestions[a];
        return question;
    }


    public String getChoice1(int a){
        String choice1 = nChoiches[a][0];
        return choice1;
    }

    public String getChoice2(int a){
        String choice2 = nChoiches[a][1];
        return choice2;
    }
    public String getChoice3(int a){
        String choice3 = nChoiches[a][2];
        return choice3;
    }
    public String getChoice4(int a){
        String choice4 = nChoiches[a][3];
        return choice4;
    }
